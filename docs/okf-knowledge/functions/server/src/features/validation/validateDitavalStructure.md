...
title: validateDitavalStructure
resource: server/src/features/validation.ts#L460-L575
generated:
  by: okf-rs/0.4.0
relationships:
  calls:
...
`function validateDitavalStructure( text: string, diagnostics: Diagnostic[] ): void`
