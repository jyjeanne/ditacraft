...
- Excluded: 0 untracked · 46247 ignored · 21 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `abc837f`
...
Cohesion: 0.10
Nodes (4): main, abc837f [npm]: bump @vscode/vsce from 3.9.2 to 4.0.0, DitaCraftAPI, detectDitaVersion()
