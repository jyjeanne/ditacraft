...
## Corpus Check
- 324 files · ~401,466 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1550 nodes · 3424 edges · 90 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: contains: 812 · imports: 628 · calls: 565 · method: 465 · imports_from: 403 · MODIFIES: 343 · ON_BRANCH: 103 · PARENT_OF: 52 · re_exports: 36 · implements: 9 · inherits: 4 · rationale_for: 4
...
- Excluded: 0 untracked · 59341 ignored · 3 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `5cbe026`
...
- `0ee101d Fix diamond-shaped keyscope graphs losing keys from re-visited submaps` --ON_BRANCH--> `claude/graphify-knowledge-graph-kii3px`  [EXTRACTED]
  git → git  _Bridges community 62 → community 7_
- `1b9198d Add graphify knowledge graph generation into docs/graph` --ON_BRANCH--> `claude/graphify-knowledge-graph-kii3px`  [EXTRACTED]
  git → git  _Bridges community 29 → community 7_
- `21950fa add nd fx unit` --ON_BRANCH--> `claude/graphify-knowledge-graph-kii3px`  [EXTRACTED]
  git → git  _Bridges community 34 → community 7_
...
- `33167a3 Fix completion parent-element stack desync, settings cache poisoning, and stale cross-file diagnostics` --ON_BRANCH--> `claude/graphify-knowledge-graph-kii3px`  [EXTRACTED]
  git → git  _Bridges community 22 → community 7_
...
Cohesion: 0.07
Nodes (24): DiagnosticItem, DiagnosticsViewProvider, DITA_SOURCES, GroupMode, isDitaUri(), DitaFileDecorationProvider, isDitaUri(), CACHE_DEFAULTS (+16 more)
...
Cohesion: 0.09
Nodes (14): FILE_SAVE_PHASES, MAP_CHANGE_PHASES, PhaseCacheEntry, SEVERITY_MAP, TEXT_EDIT_PHASES, ValidationPhase, ValidationSummary, WorkspaceContext (+6 more)
...
Cohesion: 0.09
Nodes (12): TypesXMLCatalog, TypesXMLDOMBuilder, TypesXMLModule, TypesXMLSAXParser, ICatalogValidationService, ISubjectSchemeService, KeyResolutionReport, KeySpace (+4 more)
...
Cohesion: 0.24
Nodes (12): 76690f8 Fix Windows path-comparison case sensitivity in isPathWithinWorkspace and cross-file matching, CacheConfig, KeyMetadata, KeySpaceSettings, ResolutionStep, effectiveWorkspaceFolders(), escapeRegex(), isPathWithinWorkspace() (+4 more)
...
Cohesion: 0.24
Nodes (7): PROFILING_ATTRIBUTES, PROFILING_CODES, validateProfilingAttributes(), BUNDLES, MessageBundle, setLocale(), t()
...
- **Thin community `Community 11`** (1 nodes): `DitaLinkProvider`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 20`** (1 nodes): `Logger`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (1 nodes): `DitaPreviewPanel`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 28`** (2 nodes): `ISubjectSchemeService`, `SubjectSchemeService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 42`** (2 nodes): `latest' contains 'test' but is NOT a testing term.`, `TestDetectTestingGaps`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (1 nodes): `MapVisualizerPanel`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (1 nodes): `TestBuildSummary`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (1 nodes): `TestMainIntegration`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (1 nodes): `DitaOtOutputChannel`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 65`** (2 nodes): `CatalogValidationService`, `ICatalogValidationService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (2 nodes): `ILLMProvider`, `OllamaLLMProvider`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (2 nodes): `AnthropicLLMProvider`, `ILLMProvider`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (2 nodes): `ILLMProvider`, `OpenAILLMProvider`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (1 nodes): `ValidationReportPanel`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (1 nodes): `TestConstants`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (1 nodes): `TestCreateIssue`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 79`** (1 nodes): `DtdResolver`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 81`** (2 nodes): `CopilotLLMProvider`, `ILLMProvider`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 83`** (1 nodes): `CircuitBreaker`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `KeySpaceService` connect `Community 2` to `Community 9`, `Community 35`, `Community 24`, `Community 59`, `Community 80`, `Community 8`, `Community 31`, `Community 37`, `Community 12`, `Community 19`, `Community 23`, `Community 39`, `Community 62`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `Logger` connect `Community 20` to `Community 43`, `Community 44`, `Community 21`, `Community 33`, `Community 17`, `Community 0`, `Community 47`, `Community 15`, `Community 13`, `Community 82`, `Community 38`?**
