...
exports.SubjectSchemeService = void 0;
const fs = __importStar(require("fs"));
const ANY_ELEMENT = '*';
// --- Service ---
class SubjectSchemeService {
    constructor() {
        this.cache = new Map();
     ...
     */
    parseSubjectScheme(mapFilePath) {
     ...
     */
    getValidValues(attributeName, elementName) {
     ...
     */
    isControlledAttribute(attributeName) {
        const data = this.getMergedSchemeData();
     ...
     */
    getDefaultValue(attributeName, elementName) {
        const data = this.getMergedSchemeData();
    ...
    // --- Internal: Parsing ---
    extractSubjectDefinitions(content) {
        const defs = new Map();
     ...
     */
    findClosingTag(content, startPos, tagName) {
        let depth = 1;
    ...
    processEnumerationDefs(content, subjectDefs, data) {
     ...
     */
    buildHierarchyPaths(def, parentPath, result) {
...
exports.SubjectSchemeService = SubjectSchemeService;
//# sourceMappingURL=subjectSchemeService.js.map